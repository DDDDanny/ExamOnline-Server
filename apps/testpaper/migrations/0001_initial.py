...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('user', '0006_remove_teacherinfo_subject'),
        ('testquestion', '0002_auto_20190222_1922'),
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('test_paper', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='testpaper.TestPaperInfo', verbose_name='试卷')),
                ('test_question', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='testquestion.TestQuestionInfo', verbose_name='试题')),
            ],
            options={
                'verbose_name': '试卷试题信息',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=models.Model, to='user.StudentsInfo', verbose_name='学生信息')),
            ],
            options={
                'verbose_name': '学生成绩信息',
